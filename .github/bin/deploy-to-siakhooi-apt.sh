...
readonly TARGET_GIT_EMAIL=hello-groovy@siakhooi.github.io
readonly TARGET_GIT_USERNAME=hello-groovy
TARGET_COMMIT_MESSAGE="bash-hello-groovy: Auto deploy [$(date)]"
