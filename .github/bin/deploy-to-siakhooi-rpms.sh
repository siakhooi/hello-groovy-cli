...
readonly TARGET_GIT_EMAIL=hello-groovy-cli@siakhooi.github.io
readonly TARGET_GIT_USERNAME=hello-groovy-cli
TARGET_COMMIT_MESSAGE="bash-hello-groovy-cli: Auto deploy [$(date)]"
